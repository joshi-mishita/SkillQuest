...
void autocompleteDemo(JobEngine& engine) {
    std::cout << "\n  ╔══════════════════════════════════════════╗\n";
    std::cout << "  ║     JOB TITLE AUTOCOMPLETE (Trie)        ║\n";
    std::cout << "  ╚══════════════════════════════════════════╝\n";
    std::cout << "  Type a prefix and see suggestions in real time.\n";
...
void mainMenu(AppState& app) {
    while (app.running && app.currentUser) {
        ...
        std::cout << "  ║  2. 🗺️  Career Path Navigator             ║\n";
...
int main() {
    ...
    std::cout << "  💡 Demo: username=alice  password=password123\n\n";
